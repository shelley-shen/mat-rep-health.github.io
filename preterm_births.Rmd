...
Generally in NYC neighborhoods, the overall percentage of people with health insurance is fairly high, with the exception of North Corona where only 58.5% of the population has health insurance. Despite this, it appears that those neighborhoods with less percentage of the population enrolled in health insurance have more percentages of preterm births in the population. There does not seem to be a strong relationship, however, it might be worth exploring this association through statistical methods and looking at whether health insurance also modifies the association between prenatal care and preterm births.  
