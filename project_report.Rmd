...
- `clinics`: number of clinics in 2014
- `community_health_centers`: number of community health centers in 2014
- `non_pcmd`: number of non-primary care providers in 2014
- `clinics_and_chc_count`: number of clinic & community health per 10,000 people 
