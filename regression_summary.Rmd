...
* Model selection using Lasso & LAR, which overcome many of the limitations of stepwise model selection and generally have better results
* Spatial regression to account for correlation between 
